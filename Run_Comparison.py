...
script_status = {}
script_output = {}
SCRIPTS_DIRECTORY = r'D:\svc_webscrape\Webscrapping- Webpage V2.2 (WebSocket)\Webscrapping- Webpage V2.2 (WebSocket)'
...
def flinn_vs_competitors_scripts():
    run_sequence_scripts(['Flinn_vs_Frey.py', 'Flinn_vs_Nasco.py', 'Flinn_vs_Carolina.py', 'Flinn_vs_VWR.py', 'Flinn_vs_Fisher.py', 'Flinn_vs_Wardsci.py'])
